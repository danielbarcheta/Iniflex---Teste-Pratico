...
public class Principal {
	...
	public static void main(String[] args) {
		...
		/* Para atender as requisicoes, foi utilizado uma LinkedList. Poderia se ter implementado tambem um Arraylist */
		...
		/* 3.3: Imprimindo os funcionarios presentes na LinkedList no formato requisitado*/
		...
		// Obs: Imprimindo os funcionarios novamente com os valores atualizados(a fins de correcao).
		...
		/* 3.5 e 3.6:  Agrupando os funcionarios
		num Map e imprimindo-os agrupando-os por funcao */
		...
		// -> PASSO 2: IMPRIMIR CADA UM DESSES ARRAYS(isto e, cada um dos valores de cada key que os representa)
		...
		// Passo 2: Iterar sobre a lista para encontrar o funcionario que possui esta idade e printa-lo
		...
		/* 3.11(Mal-resolvido): Imprimindo o total dos salarios dos funcionarios */
		/* Obs: a soma esta incorreta por problemas de imprecisao relacionados ao BigDecimal. 
		 * Ainda nao consegui resolver este item. Mesmo convertendo para int, a soma
		 * dos salarios resulta em um valor acima do esperado.
		 */
